...
const Signup = () => {
  ...
  const handleChangeEmail = (e) => {
    ...
    const isThereDomain = e.target.value.split("@")[1]?.split(".")[0]
      ? true
      : false;
    const isThereTopLevelDomain =
      e.target.value.split(".")[1]?.length > 0 ? true : false;
    setDataForm({
      ...dataForm,
  ...
  return (
    <div>
      <Head>
        <title>Officity | Sign Up</title>
        <link rel="icon" href="/officity-logo.svg" />
      </Head>
      <ContainerAuth>
        {!isTabletOrMobile && (
          <BannerAuth src="/signup.svg" alt="login-photo" />
        )}
              ...
              <ContainerInputAuth>
                ...
                <ContainerLabelInput>
                  ...
                  <InputAuthPassword
                    ...
                    validators={
                      [isPasswordValid.characters, isAllValid] && [
                        isPasswordValid.uppercase,
                        isAllValid,
                      ] && [isPasswordValid.number, isAllValid]
                    }
                    subValidators={[
                      isPasswordValid.characters,
                      isPasswordValid.uppercase,
                ...
                <ContainerLabelInput>
                  ...
                  <InputAuthPassword
                    ...
                    validators={
                      [isConfirmPasswordValid.characters, isAllValid] && [
                        isConfirmPasswordValid.uppercase,
                        isAllValid,
                      ] && [isConfirmPasswordValid.number, isAllValid]
                    }
                    subValidators={[
                      isConfirmPasswordValid.characters,
                      isConfirmPasswordValid.uppercase,
